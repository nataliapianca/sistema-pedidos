package com.natpianca.sistemapedidos.config;
...
import com.natpianca.sistemapedidos.entities.enums.OrderStatus;
import com.natpianca.sistemapedidos.repositories.CategoryRepository;
import com.natpianca.sistemapedidos.repositories.OrderRepository;
import com.natpianca.sistemapedidos.repositories.ProductRepository;
...
public class TesteConfig implements CommandLineRunner {
	...
	// popula o banco com dados teste
	@Override
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1); // associao do user
